...
function finishGame(){
  ...
  answers.replaceChildren();
  photo.src="images/animals/lion.jpg?v=14";
...
resizeCanvas();
setupVoice();
instruction.textContent=`V14 พร้อมแล้ว • ฐานข้อมูล ${ANIMALS.length} ชนิด • กดเริ่มเกมได้เลย`;
enableCamera();

console.log("Animal Game V14 loaded successfully", ANIMALS.length);
})();
