(function(){
 ...
 <div class="mick-investment-head"><div><div class="mick-kicker">SNOW MALTON GATES 36 • MICK INVESTMENT</div><h2>Market Intelligence</h2><p>GLOBAL MARKET + THAILAND MARKET • ตรวจล่าสุด <span id="mickHomeUpdated">${fmt()}</span></p></div><a class="mick-investment-open" href="mick-investment.html?v=25">📈 เปิด Investment Dashboard</a></div>
 <div class="mick-market-sections">
  <article class="mick-market-panel"><div class="mick-panel-title"><span class="mick-country-flag" role="img" aria-label="ธงชาติสหรัฐอเมริกา">🇺🇸</span><div><small>GLOBAL MARKET</small><h3>USD/THB & United States</h3></div></div><div class="mick-market-grid">
  ...
  <article class="mick-market-panel"><div class="mick-panel-title"><span class="mick-country-flag" role="img" aria-label="ธงชาติไทย">🇹🇭</span><div><small>THAILAND MARKET</small><h3>Thailand Macro Indicators</h3></div></div><div class="mick-market-grid">
